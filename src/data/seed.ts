...
export const seedHabits: Habit[] = [
  { id: "h1", name: "Hidratação", targetType: "check", active: true, createdAt: "2024-01-01T00:00:00Z" },
  { id: "h2", name: "Treino", targetType: "minutes", targetValue: 40, active: true, createdAt: "2024-01-01T00:00:00Z" },
  { id: "h3", name: "Leitura", targetType: "minutes", targetValue: 20, active: true, createdAt: "2024-01-01T00:00:00Z" },
  { id: "h4", name: "Proteína no almoço", targetType: "check", active: true, createdAt: "2024-01-01T00:00:00Z" },
  { id: "h5", name: "8k passos", targetType: "check", active: true, createdAt: "2024-01-01T00:00:00Z" },
  { id: "h6", name: "Dormir antes de 23h", targetType: "check", active: true, createdAt: "2024-01-01T00:00:00Z" },
];
...
export function generateSeedRecords(): DailyRecord[] {
  ...
  for (let i = 1; i <= 50; i++) {
    ...
    // ~10% skip rate → ~45 records
    if (seeded(ds + "skip", 0, 9) === 0) continue;

    const mood = seeded(ds + "mood", 1, 5);
