    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="w-full max-w-sm space-y-8 text-center">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-foreground">life metrics.</h1>
            <p className="text-xs text-muted-foreground mt-1 tracking-wide">seu progresso visível</p>
          </div>
