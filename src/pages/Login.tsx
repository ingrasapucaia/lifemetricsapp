        ...
        <Card className="border-0 shadow-card">
          <CardContent className="p-6 space-y-5">
            ...
            <div className="space-y-2.5">
              ...
              <Button
                className="w-full rounded-full gap-2 bg-black text-white hover:bg-black/90"
            ...
            <div className="text-center space-y-2">
              ...
              <Link to="/recuperar-senha" className="text-xs text-muted-foreground hover:underline block">
                Esqueci minha senha
              </Link>
            </div>
          </CardContent>
